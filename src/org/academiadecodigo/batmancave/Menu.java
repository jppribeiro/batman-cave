...
public class Menu implements KeyboardHandler {
    ...
    public Menu(){
        ...
        buttonPressed = new Picture(483, 550, "resources/Menu/buttons/button pressed.png");
        buttonPressed1 = new Picture(483, 650, "resources/Menu/buttons/button pressed.png");
        pressSpace = new Picture(539, 565, "resources/Menu/buttons/Press space.png");
        pressEsc = new Picture(539, 665, "resources/Menu/buttons/Press esc.png");
        title.draw();
        button.draw();
        button1.draw();
        start.draw();
